    ...
    <div class="main-menu">
        <div class="scroll">
            <ul class="list-unstyled">
                ...
                <li class="#"><a href="<?php echo e(route('dashboard.index')); ?>"><i class="iconsminds-check"></i> Surveys</a></li>
    ...
    <div class="sub-menu">
        <div class="scroll">
            ...
            <ul class="list-unstyled" data-link="responses" id="responses">
                ...
                <li>
                    <a href="<?php echo e(route('submissions.index')); ?>"><i class="iconsminds-yes"></i><span class="d-inline-block">Survey One Explained</span></a>
                </li>
                <li>
...
<?php /**PATH D:\Projects\new-projects-dev\app\resources\views/inc/dashboard/responses/side-bar.blade.php ENDPATH**/ ?>