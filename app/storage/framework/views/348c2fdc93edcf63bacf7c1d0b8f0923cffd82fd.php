...
<body id="app-container" class="menu-sub-hidden show-spinner right-menu">
    ...
    <?php echo $__env->make('inc.dashboard.responses.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


    <?php echo $__env->make('inc.dashboard.responses.side-bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('inc.dashboard.responses.responses-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\new-projects-dev\app\resources\views/dashboard/responses/index.blade.php ENDPATH**/ ?>