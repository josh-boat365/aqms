                    ...
                    <div class="card auth-card">
                        ...
                        <div class="form-side position-relative">
                            ...
                            <form class="tooltip-right-bottom" novalidate method="POST" action="<?php echo e(route('login')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="form-group has-float-label"><input value="<?php echo e(old('email')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\_kay_\Documents\Projects\aqms\app\resources\views/auth/login.blade.php ENDPATH**/ ?>