        ...
        <div class="header-icons d-inline-block align-middle">
            ...
            <div class="position-relative d-inline-block">
                <button class="header-icon btn btn-empty" type="button" id="notificationButton" data-toggle="dropdown"
                    ...
                    <span class="count"><?php echo e($notifications->count()); ?></span>
                </button>
                    ...
                    <div class="scroll">
                        ...
                        <?php $__currentLoopData = $notifications->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="<?php echo e(asset('img/profiles/l-2.jpg')); ?>" alt="Notification Image"
                                        class="img-thumbnail list-thumbnail xsmall border-0 rounded-circle">

                                </a>
                                <div class="pl-3">
                                    <?php if($notification->notification_type_id == 2): ?>
                                        
                                        <a href="<?php echo e(url('/dashboard/submissions/' . $notification->survey_id )); ?>">
                                        <?php else: ?>
                                            <a href="">
                                    <?php endif; ?>
                                    <p class="font-weight-medium mb-1">
                                        <?php if($notification->notification_type_id == 1): ?>
                                            new registered user
                                        <?php elseif($notification->notification_type_id == 2): ?>
                                            new survey submitted
                                        <?php endif; ?>
                                    </p>
                                    <?php if($notification->notification_type_id == 1): ?>
                                        <p class="font-weight-medium mb-1"> - <?php $__currentLoopData = $users->where('id', $notification->user_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="user d-inline-block"><button class="btn btn-empty p-0" type="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false"><span
                    class="name"><?php echo e(auth()->user()->firstName); ?></span> <span><img alt="Profile Picture"
                        src="<?php echo e(asset('img/profiles/p-a1.png')); ?>"></span></button>
            <div class="dropdown-menu dropdown-menu-right mt-3">
                <a class="dropdown-item" href="<?php echo e(route('dashboard.profile')); ?>">Profile</a>
...
<?php /**PATH C:\Users\Fuad\Documents\GitHub\aqms\app\resources\views/inc/dashboard/navbar.blade.php ENDPATH**/ ?>