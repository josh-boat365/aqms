...
<body id="app-container" class="menu-sub-hidden show-spinner right-menu">
    ...
    <?php $__env->startSection('survey-tiles'); ?>
        ...
        <?php $__currentLoopData = $surveys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $survey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo $__env->make('inc.alumnus.survey.survey-tile', ['survey' => $survey, 'status' => $survey->status], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('inc.alumnus.survey.survey-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\_kay_\Documents\Projects\aqms\app\resources\views/alumnus/surveys/index.blade.php ENDPATH**/ ?>