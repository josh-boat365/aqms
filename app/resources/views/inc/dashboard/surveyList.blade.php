                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Add New</h5><button type="button"
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            ...
                                            <div class="form-group"><label>Details</label> <textarea placeholder=""
                    ...
                    <div class="collapse d-md-block" id="displayOptions">
                        <div class="d-block d-md-inline-block">
                            <div class="btn-group float-md-left mr-1 mb-1"><button
                                    ...
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Order By</button>
