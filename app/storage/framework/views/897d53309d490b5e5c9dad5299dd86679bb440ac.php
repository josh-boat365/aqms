...
<body id="app-container" class="menu-sub-hidden show-spinner right-menu">
    ...
    <?php $__env->startSection('submission-tiles'); ?>
        <?php $__currentLoopData = $allSurveys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $survey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo $__env->make('inc.dashboard.submissions.submission-tile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('inc.dashboard.responses.responses-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Fuad\Documents\GitHub\aqms\app\resources\views/dashboard/submissions/index.blade.php ENDPATH**/ ?>