            ...
            (e.cleanData =
                ...
                function (n) {
                    ...
                    for (s = 0; null != n[s]; s++) {
                        a = n[s];
                        try {
                            (o = e._data(a, "events")) && o.remove && e(a).triggerHandler("remove");
                        } catch (n) {}
                    }
                    t(n);
                }));
    var n = null,
            ...
            position: function (e, t, n) {
                ...
                if (t || n) {
                    if ("maintain" === t && "maintain" === n) o = e.$menu.position();
                        ...
                        o = { top: n - s.top, left: t - s.left };
                    }
                    var i = a.scrollTop() + a.height(),
                        c = a.scrollLeft() + a.width(),
                        l = e.$menu.outerHeight(),
                        r = e.$menu.outerWidth();
                    o.top + l > i && (o.top -= l), o.top < 0 && (o.top = 0), o.left + r > c && (o.left -= r), o.left < 0 && (o.left = 0), e.$menu.css(o);
        ...
        d = {
            ...
            contextmenu: function (t) {
                ...
                if (
                    ...
                    !(
                        ...
                        o.hasClass("context-menu-active") ||
                        o.hasClass("context-menu-disabled")
                    ))
                ) {
                    if (((n = o), t.data.build)) {
                        var a = t.data.build(n, t);
                        if (!1 === a) return;
                        if (((t.data = e.extend(!0, {}, r, t.data, a || {})), !t.data.items || e.isEmptyObject(t.data.items)))
                    ...
                    m.show.call(o, t.data, t.pageX, t.pageY);
                }
            },
            click: function (t) {
            ...
            mousedown: function (t) {
                var o = e(this);
                n && n.length && !n.is(o) && n.data("contextMenu").$menu.trigger("contextmenu:hide"), 2 === t.button && (n = o.data("contextMenuActive", !0));
            },
            mouseup: function (t) {
                var o = e(this);
                o.data("contextMenuActive") &&
                    n &&
                    n.length &&
                    n.is(o) &&
                    !o.hasClass("context-menu-disabled") &&
                    (t.preventDefault(), t.stopImmediatePropagation(), (n = o).trigger(e.Event("contextmenu", { data: t.data, pageX: t.pageX, pageY: t.pageY }))),
                    o.removeData("contextMenuActive");
            },
            mouseenter: function (t) {
                ...
                a.is(".context-menu-list") ||
                    ...
                    (u.timer = setTimeout(function () {
                        (u.timer = null), s.off("mousemove.contextMenuShow"), (n = o).trigger(e.Event("contextmenu", { data: u.data, pageX: u.pageX, pageY: u.pageY }));
                    }, t.data.delay)));
            },
            ...
            layerClick: function (t) {
                ...
                t.preventDefault(),
                    setTimeout(function () {
                        if (r) null != s && null !== s.$menu && void 0 !== s.$menu && s.$menu.trigger("contextmenu:hide");
                        else {
                            var u,
                                d = ("left" === s.trigger && 0 === i) || ("right" === s.trigger && 2 === i);
                            if (document.elementFromPoint && s.$layer) {
                                if ((s.$layer.hide(), (n = document.elementFromPoint(c - a.scrollLeft(), l - a.scrollTop())).isContentEditable)) {
                            ...
                            if (s.hideOnSecondTrigger && d && null !== s.$menu && void 0 !== s.$menu) s.$menu.trigger("contextmenu:hide");
                                ...
                                if (s.reposition && d)
                                    if (document.elementFromPoint) {
                                        ...
                                        (o.top += u.scrollTop()),
                                        o.top <= t.pageY &&
                                            ((o.left += u.scrollLeft()), o.left <= t.pageX && ((o.bottom = o.top + s.$trigger.outerHeight()), o.bottom >= t.pageY && ((o.right = o.left + s.$trigger.outerWidth()), o.right >= t.pageX))))
                                    )
            ...
            key: function (e) {
                ...
                var o = 0,
                    a = function (e) {
                        "" !== e.style.zIndex ? (o = e.style.zIndex) : null !== e.offsetParent && void 0 !== e.offsetParent ? a(e.offsetParent) : null !== e.parentElement && void 0 !== e.parentElement && a(e.parentElement);
                    };
                if ((a(e.target), !(t.$menu && parseInt(o, 10) > parseInt(t.$menu.css("zIndex"), 10)))) {
                    switch (e.keyCode) {
                        case 9:
                        case 38:
            ...
            prevItem: function (t) {
                ...
                if (n.$selected) {
                    var a = n.$selected;
                    (n = n.$selected.parent().data("contextMenu") || {}).$selected = a;
                }
            ...
            itemMouseenter: function (t) {
                ...
                (s.hovering = !0),
                    ...
                    (a.$menu ? a : s).$menu
                        ...
                        .children(".hover")
                        .trigger("contextmenu:blur"),
                    n.hasClass(s.classNames.disabled) || n.hasClass(s.classNames.notSelectable) ? (a.$selected = null) : n.trigger("contextmenu:focus");
            },
            itemMouseleave: function (t) {
                var n = e(this),
                    ...
                    a = o.contextMenu,
                    s = o.contextMenuRoot;
                if (s !== a && s.$layer && s.$layer.is(t.relatedTarget))
                    return void 0 !== s.$selected && null !== s.$selected && s.$selected.trigger("contextmenu:blur"), t.preventDefault(), t.stopImmediatePropagation(), void (s.$selected = a.$selected = a.$node);
                (a && a.$menu && a.$menu.hasClass("context-menu-visible")) || n.trigger("contextmenu:blur");
            },
            itemClick: function (t) {
                var n,
                    ...
                    i = a.contextMenuRoot,
                    c = a.contextMenuKey;
                if (!(!s.items[c] || o.is("." + i.classNames.disabled + ", .context-menu-separator, ." + i.classNames.notSelectable) || (o.is(".context-menu-submenu") && !1 === i.selectableSubMenu))) {
            ...
            focusItem: function (t) {
                ...
                n.hasClass(s.classNames.disabled) ||
                    ...
                    (n
                        ...
                        .trigger("contextmenu:blur"),
                    (a.$selected = s.$selected = n),
                    a && a.$node && a.$node.hasClass("context-menu-submenu") && a.$node.addClass(s.classNames.hover),
                    a.$node && s.positionSubmenu.call(a.$node, a.$menu));
            },
            blurItem: function (t) {
                t.stopPropagation();
                var n = e(this),
        ...
        m = {
            show: function (t, o, a) {
                ...
                if ((e("#context-menu-layer").trigger("mousedown"), (t.$trigger = s), !1 !== t.events.show.call(s, t)))
                    if (!1 !== m.update.call(s, t)) {
                        if ((t.position.call(s, t, o, a), t.zIndex)) {
                            var c = t.zIndex;
            ...
            hide: function (t, o) {
                var a = e(this);
                if ((t || (t = a.data("contextMenu") || {}), o || !t.events || !1 !== t.events.hide.call(a, t))) {
            ...
            create: function (t, n) {
                ...
                void 0 === n && (n = t),
                    ...
                    e.each(["callbacks", "commands", "inputs"], function (e, o) {
                        (t[o] = {}), n[o] || (n[o] = {});
                    }),
                    n.accesskeys || (n.accesskeys = {}),
                    e.each(t.items, function (a, s) {
                        ...
                        if (
                            ...
                            (s.$node = i.data({ contextMenu: t, contextMenuRoot: n, contextMenuKey: a })),
                            void 0 !== s.accesskey)
                        )
                            for (
                                var u,
                                ...
                                if (!n.accesskeys[u]) {
                                    var h = (n.accesskeys[u] = s).name.match(new RegExp("^(.*?)(" + u + ")(.*)$", "i"));
                                    h && ((s._beforeAccesskey = h[1]), (s._accesskey = h[2]), (s._afterAccesskey = h[3]));
                                    break;
                                }
                        if (s.type && l[s.type])
                            l[s.type].call(i, s, t, n),
                                e.each([t, n], function (n, o) {
                                    (o.commands[a] = s), !e.isFunction(s.callback) || (void 0 !== o.callbacks[a] && void 0 !== t.type) || (o.callbacks[a] = s.callback);
                                });
                        else {
                            switch (
                                ("cm_seperator" === s.type
                                ...
                                case "text":
                                    r = e('<input type="text" value="1" name="" />')
                                        .attr("name", "context-menu-input-" + a)
                                        .val(s.value || "")
                                        .appendTo(c);
                                    break;
                                case "textarea":
                            ...
                            s.type && "sub" !== s.type && "html" !== s.type && "cm_seperator" !== s.type && (r.on("focus", d.focusInput).on("blur", d.blurInput), s.events && r.on(s.events, t)),
                                s.icon &&
                                    (e.isFunction(s.icon)
                                        ? (s._icon = s.icon.call(this, this, i, a, s))
                                        : "string" != typeof s.icon || ("fab " !== s.icon.substring(0, 4) && "fas " !== s.icon.substring(0, 4) && "far " !== s.icon.substring(0, 4) && "fal " !== s.icon.substring(0, 4))
                                        ...
                                        : (i.addClass(n.classNames.icon + " " + n.classNames.icon + "--fa5"), (s._icon = e('<i class="' + s.icon + '"></i>'))),
                                    "string" == typeof s._icon ? i.addClass(s._icon) : i.prepend(s._icon));
                        }
            ...
            resize: function (t, n) {
                ...
                t.css({ position: "absolute", display: "block" }),
                    t.data("width", (o = t.get(0)).getBoundingClientRect ? Math.ceil(o.getBoundingClientRect().width) : t.outerWidth() + 1),
                ...
                return (
                    t.$menu.children().each(function () {
                        var s,
                            ...
                            l = t.items[c],
                            r = (e.isFunction(l.disabled) && l.disabled.call(o, c, n)) || !0 === l.disabled;
                        if (
                            ((s = e.isFunction(l.visible) ? l.visible.call(o, c, n) : void 0 === l.visible || !0 === l.visible) && (a = !0),
                            i[s ? "show" : "hide"](),
                            i[r ? "addClass" : "removeClass"](n.classNames.disabled),
                            e.isFunction(l.icon))
                        ) {
                            i.removeClass(l._icon);
                            var u = l.icon.call(this, o, i, c, l);
                            "string" == typeof u ? i.addClass(u) : i.prepend(u);
                        }
                        if (l.type)
                            switch ((i.find("input, select, textarea").prop("disabled", r), l.type)) {
                                case "text":
                                case "textarea":
                                    l.$input.val(l.value || "");
                                    break;
                                case "checkbox":
                                case "radio":
                                    l.$input.val(l.value || "").prop("checked", !!l.selected);
                                    break;
                                case "select":
                                    l.$input.val((0 === l.selected ? "0" : l.selected) || "");
                            }
                        l.$menu && m.update.call(o, l, n) && (a = !0);
                    }),
                    a
                );
            },
            layer: function (t, n) {
                var o = (t.$layer = e('<div id="context-menu-layer"></div>')
                    .css({ height: a.height(), width: a.width(), display: "block", position: "fixed", "z-index": n, top: 0, left: 0, opacity: 0, filter: "alpha(opacity=0)", "background-color": "#000" })
                    .data("contextMenuRoot", t)
                    .insertBefore(this)
                    .on("contextmenu", d.abortevent)
                    .on("mousedown", d.layerClick));
                return void 0 === document.body.style.maxWidth && o.css({ position: "absolute", height: e(document).height() }), o;
            },
            ...
            activated: function (t) {
                var n = t.$menu,
                    ...
                    i = n.height();
                a < i ? n.css({ height: a + "px", "overflow-x": "hidden", "overflow-y": "auto", top: s + "px" }) : (o.top < s || o.top + i > s + a) && n.css({ top: "0px" });
            },
        };
    function p(t) {
    ...
    (e.fn.contextMenu = function (t) {
        ...
        if (0 < this.length)
            ...
            e.each(c, function () {
                ...
                d.contextmenu.call(o.target, o);
        return this;
    }),
        (e.contextMenu = function (t, n) {
            "string" != typeof t && ((n = t), (t = "create")), "string" == typeof n ? (n = { selector: n }) : void 0 === n && (n = {});
            var a = e.extend(!0, {}, r, n || {}),
                l = e(document),
                u = l,
                p = !1;
            switch ((a.context && a.context.length ? ((u = e(a.context).first()), (a.context = u.get(0)), (p = !e(a.context).is(document))) : (a.context = document), t)) {
                case "update":
                    if (p) m.update(u);
                ...
                case "create":
                    ...
                    if ((s++, (a.ns = ".contextMenu" + s), p || (i[a.selector] = a.ns), (c[a.ns] = a).trigger || (a.trigger = "right"), !o)) {
                        var h = "click" === a.itemClickEvent ? "click.contextMenu" : "mouseup.contextMenu",
                            x = {
                        ...
                        (x[h] = d.itemClick),
                            l
                                ...
                                .on(x, ".context-menu-item"),
                            (o = !0);
                    }
                    switch (
                        (u.on("contextmenu" + a.ns, a.selector, a, d.contextmenu),
                        p &&
                            u.on("remove" + a.ns, function () {
                                e(this).contextMenu("destroy");
                            }),
                        a.trigger)
                    ) {
                        case "hover":
                            u.on("mouseenter" + a.ns, a.selector, a, d.mouseenter).on("mouseleave" + a.ns, a.selector, a, d.mouseleave);
                            break;
                        case "left":
                            u.on("click" + a.ns, a.selector, a, d.click);
                            break;
                        case "touchstart":
                            u.on("touchstart" + a.ns, a.selector, a, d.click);
                    }
                    a.build || m.create(a);
                    break;
                case "destroy":
                    ...
                    if (p) {
                        ...
                        e.each(c, function (t, n) {
                            ...
                            (v = e(".context-menu-list").filter(":visible")).length && v.data().contextMenuRoot.$trigger.is(e(n.context).find(n.selector)) && v.trigger("contextmenu:hide", { force: !0 });
                            try {
                        ...
                        if (i[a.selector]) {
                            (v = e(".context-menu-list").filter(":visible")).length && v.data().contextMenuRoot.$trigger.is(a.selector) && v.trigger("contextmenu:hide", { force: !0 });
                            try {
                                c[i[a.selector]].$menu && c[i[a.selector]].$menu.remove(), delete c[i[a.selector]];
                            } catch (t) {
                                c[i[a.selector]] = null;
                            }
                            l.off(i[a.selector]);
                ...
                (function t(n, o, a) {
                    return (
                        ...
                        o.each(function () {
                            ...
                            switch (("label" === l && i.find("input, textarea, select").length && ((o = i.text()), (l = (c = (i = i.children().first()).get(0)).nodeName.toLowerCase())), l)) {
                                case "menu":
                                    (s = { name: i.attr("label"), items: {} }), (a = t(s.items, i.children(), a));
                                    break;
                                case "a":
                                case "button":
                                    s = {
                                ...
                                case "input":
                                    switch (i.attr("type")) {
                                        case "text":
                                            s = { type: "text", name: o || p(c), disabled: !!i.attr("disabled"), value: i.val() };
                                            break;
                                        case "checkbox":
                                            s = { type: "checkbox", name: o || p(c), disabled: !!i.attr("disabled"), selected: !!i.attr("checked") };
                                            break;
                                        case "radio":
                                            s = { type: "radio", name: o || p(c), disabled: !!i.attr("disabled"), radio: !!i.attr("name"), value: i.val(), selected: !!i.attr("checked") };
                                            break;
                                        default:
                                            s = void 0;
                                    }
                                    break;
                                case "select":
                                    (s = { type: "select", name: o || p(c), disabled: !!i.attr("disabled"), selected: i.val(), options: {} }),
                                        i.children().each(function () {
                                            s.options[this.value] = e(this).text();
                                        });
                                    break;
                                case "textarea":
                                    s = { type: "textarea", name: o || p(c), disabled: !!i.attr("disabled"), value: i.val() };
                                    break;
                                case "label":
                                    break;
                                default:
