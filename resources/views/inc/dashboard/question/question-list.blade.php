    <div class="col-12 col-lg-8 survey-wrapper section-1 current" style="display: none">
        <div class=" mb-3  border-primary card section-card" style="border-top: 7px solid #f3f3f3; display: none">
            ...
            <div class="card-body">
                ...
                <input type="text" name="section_header" id="section-header-input" style="display: none"
                ...
                <textarea name="section_description" id="section-description-input" style="display: none"
