...
<body id="app-container" class="menu-sub-hidden show-spinner right-menu">
    ...
    <?php $__env->startSection('alumni-list'); ?>
    ...
    <?php $__env->startSection('question-list'); ?>
        <?php echo $__env->make('inc.dashboard.responses.question-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php $__env->stopSection(); ?>
...
<?php echo $__env->make('inc.dashboard.responses.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\new-projects-dev\app\resources\views/dashboard/submissions/show.blade.php ENDPATH**/ ?>