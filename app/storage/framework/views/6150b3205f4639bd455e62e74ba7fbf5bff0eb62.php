...
<body id="app-container" class="menu-sub-hidden  right-menu show-spinner">
    ...
    <?php $__env->startSection('question-list'); ?>
        <?php echo $__env->make('inc.alumnus.question.question-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php $__env->startSection('stat'); ?>
        ...
        <li class="active"><a href="#"> Progress <span class="float-right"><?php echo e('4/50'); ?></span></a></li>
...
<?php echo $__env->make('inc.alumnus.question.question-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\_kay_\Documents\Projects\aqms\app\resources\views/alumnus/surveys/show.blade.php ENDPATH**/ ?>