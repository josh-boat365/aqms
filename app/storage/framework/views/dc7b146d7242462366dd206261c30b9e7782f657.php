    ...
    <div class="main-menu">
        <div class="scroll">
            <ul class="list-unstyled">
                ...
                <li id="user-section"><a href="<?php echo e(route('users.index')); ?>"><i class="simple-icon-people"></i>Users</a></li>
                <li id="submission-section"><a href="<?php echo e(route('submissions.index')); ?>"><i class="iconsminds-bar-chart-4"></i>Submissions</a></li>
                <li id="profile-section"><a href="<?php echo e(route('dashboard.profile')); ?>"><i class="simple-icon-people"></i>Profile</a></li>
            </ul>
        </div>
    </div>
    <div class="sub-menu">
...
<?php /**PATH D:\Projects\new-projects-dev\app\resources\views/inc/dashboard/side-bar.blade.php ENDPATH**/ ?>