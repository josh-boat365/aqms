    ...
    !(function() {
        ...
        $("body").on("click", ".notify-btn", function(e) {
                ...
                e.preventDefault(),
                    ...
                    (a = $(this).data("align")),
                    (n = "primary"),
                    $.notify({ title: "Bootstrap Notify", message: "Here is a notification!", target: "_blank" }, {
                        element: "body",
                        position: null,
                        type: n,
                        allow_dismiss: !0,
        ...
        if (
            ("undefined" != typeof ClassicEditor && ClassicEditor.create(document.querySelector("#ckEditorClassic")).catch(function(e) {}),
                ...
                //         },
                //     },
                //     items: { copy: { name: "Deploy", className: "simple-icon-docs" }, archive: { name: "Move to archive", className: "simple-icon-drawer" }, delete: { name: "Delete", className: "simple-icon-trash" } },
                // }),
                $().contextMenu &&
                $.contextMenu({
                    selector: ".draft",
                ...
                $.contextMenu({
                    ...
                    items: { archive: { name: "move to archive", className: "simple-icon-drawer" } },
                }),
                $().contextMenu &&
                $.contextMenu({
                    selector: ".archive",
